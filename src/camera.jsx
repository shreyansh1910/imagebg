...
const CameraComponent = ({ onCapture }) => {
  ...
  return (
    <div>
      <button  className="selectfile positions" style={{top:'50%' ,left:'5%'}} onClick={toggleCamera}>
        {cameraOn ? 'Turn off camera' : 'Turn on camera'}
      </button>
      {cameraOn && (
        <div >
          <Webcam audio={false} ref={webcamRef}  style={{width:"50%", height:"50%" ,position:'relative',left:'35%',top:'20%'}} />
