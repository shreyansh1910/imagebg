...
function App() {
  ...
  return (
    <div style={{ overflow:'hidden'}}>
      ...
      <div >
       <div >
        <button className="selectfile positions" style={{top:'30%',left:'5%'}} onClick={handleupload}>Show photo</button>
        ...
        <label  className="selectfile positions" style={{top:'10%',left:'5%'}} for="file">
          Select file
        </label>
        </div>
